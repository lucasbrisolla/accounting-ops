...
Piloto de destilação editorial do livro *Budgeting* (Steven Bragg) para aprofundar o `accounting-ops`.
...
O modelo desta pasta segue o padrão editorial já testado em outros livros de `books/`, com foco mais forte em sistema orçamentário, drivers, integração operacional e leitura prospectiva do negócio.

## Estratégia

1. **Índice** (`budgeting-index.md`) — mapa de destilação editorial do livro.
...
> "Uma pessoa de accounting, controladoria ou FP&A usaria isso para planejar, revisar, desafiar premissas ou conectar orçamento com operação e resultado sem reescrever do zero?"
...
Este livro tende a alimentar mais fortemente workflows, concepts, playbooks e alguns processos ligados a orçamento integrado, flexible budgeting, CAPEX e conexão entre planejamento e operação.
